...
public class CheckoutEntity {
    ...
    @Column(name = "details", columnDefinition = "jsonb default null")
...
//    private CheckoutDelivery delivery;
    ...
    @Column(name = "products", columnDefinition = "jsonb default null")
    @Convert(converter = CheckoutProductConverter.class)
    @ColumnTransformer(write = "?::jsonb")
    private List<CheckoutProduct> products;

    @Column(name = "total", columnDefinition = "jsonb default null")
