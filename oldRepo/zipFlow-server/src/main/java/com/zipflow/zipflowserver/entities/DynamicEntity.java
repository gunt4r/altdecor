...
public class DynamicEntity {
    ...
    @Column(name = "main_details", columnDefinition = "jsonb default null")
    @Convert(converter = MainDetailsConverter.class)
    @ColumnTransformer(write = "?::jsonb")
    private MainDetails main_details;

    @Column(name = "keys", columnDefinition = "jsonb default null")
    @Convert(converter = KeyListConverter.class)
    @ColumnTransformer(write = "?::jsonb")
    private List<Key> keys;

    @Column(name = "filter_keys", columnDefinition = "jsonb default null")
    @Convert(converter = FilterKeyListConverter.class)
    @ColumnTransformer(write = "?::jsonb")
    private List<FilterKey> filter_keys;

    @Column(name = "main_controls", columnDefinition = "jsonb default null")
